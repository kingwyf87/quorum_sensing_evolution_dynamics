...
function main_QS_Auto(coop_Cost::Float64,sig_Cost::Float64,lambda::Float64,K::Float64,mu_Cheats::Float64,rep_Num::Int64)
    ...
    auto_R = init_R*ones(Float64,size_Pop)
    ...
    auto_pro_Rate = zeros(Float64,size_Pop)
    ...
    auto_R_Evo = zeros(Float64,max_G)
    ...
    auto_pro_Rate_nonCheats_Evo = zeros(Float64,max_G)
    ...
    for g = 1:max_G
        ...
        auto_pro_Rate = auto_pro_Rate[index_Select]
        ...
        if numCheats_Evo[g]<size_Pop
            ...
            auto_R_nonCheats_Evo[g] = mean(auto_R[index_nonCheats])
            ...
            auto_pro_Rate_nonCheats_Evo[g] = mean(auto_pro_Rate[index_nonCheats])
